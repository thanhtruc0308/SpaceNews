...
<div class="main-content-container">
    ...
    <div class="list-groups-container">
        <div class="search-block">
            <form class="search" [formGroup]="searchForm" autocomplete="off" (ngSubmit)="ClickBtn()">
                <mat-form-field class="searchbar-form-field" appearance="standard">
                    <input type="text" matInput 
                            placeholder="What your Group you want to Search" 
                            name= "search" 
                            formControlName="keyWord">
                    <mat-icon class='search-icon' style ='color:#259CD7' matSuffix>search</mat-icon>            
                </mat-form-field>
            </form>
        </div>
                ...
                <mat-list-item class="groups-container" *ngFor="let group of groups">
                    <div class="group">
                        ...
                        <div class="group-button">
                            ...
                            <button class="edit" (click)="editGroup(group.id)">
                                Edit
                            </button>
